<template>
  <div class="messageProductCard" @click="jumpProductCard">
    ...
    <image v-else class="productImg" :src="props.payload.content.pic" />
  ...
  setup(props: Props, { emit }) {
    const jumpProductCard = () => {
      if (window) {
        ...
        uni && uni.navigateTo({ url: `/pages/TUIKit/components/TUIChat/web-view?url=${props.payload.content.url}` })
      }
    };
    return {
      props,
