<template>
  ...
  >
    <div
	  :style=" isUniFrameWork && 'background-color: #fff; margin-bottom: 10rpx; padding: 30rpx; border-radius: 10rpx; box-shadow: 0.5rpx 2rpx 1rpx #cccccc;'"
      :class="[
    ...
    >
      ...
      ></Icon> -->
	  <imageIcon width="50rpx" height="50rpx" :name="iconUrl"></imageIcon>
    </div>
