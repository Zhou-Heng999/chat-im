...
const onCurrentConversationID=() => cancelQuote()
...
const getQuoteMsg=(quoteMessage)=> {
				let robj = {
					_quoteContentText: "",
					_type: -1
				}
...
const quoteContentText = computed(() => {
  ...
  console.log('111',quoteMessage.value)
  let text = getQuoteMsg(quoteMessage.value)._quoteContentText;
  return tc(text);
});
