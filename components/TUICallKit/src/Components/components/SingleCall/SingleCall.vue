<template>
  <div :class="bodyStyle">
    ...
    <div class="topToolbar-desk" v-if="!isMobile">
      ...
      <FloatWindowDesk v-if="isShowFloatWindow" :local-user-info="localUserInfo" @closeFloatWindow="handCloseWindow"></FloatWindowDesk>
    </div>

    <!-- 移动端顶部菜单栏 -->
    <div class="topToolbar-mobile" v-if="isMobile">
